...
<head>
    ...
    <style>
        /* @font-face {
            ...
            src: url({{ url('fonts/Calibri Regular.ttf') }});
        } */
        *{
            font-size: 13px;
            /* font-family: Calibri Regular; */
...
<div class="container-fluid">
    ...
    <table>
        ...
        <tr>
            <td>
                {!! !empty($user->profile_description) ? $user->profile_description :  ''  !!}<hr>
            </td>
        </tr>
    </table>
    {{-- <table>
        <tr>
            <td colspan="2" style="padding-bottom: 20px">
                <center><b>PROF. COMPETENCIES</b></center>
            </td>
        </tr>
        <tr>
            <td style="width: 50%">
    ...
    <table>
        ...
        <tr>
            <td>
                <b>{!! $employment->position  !!}</b> <span style="color: rgb(139, 139, 139)">| {!! $employment->from  !!} – {!! $employment->to  !!}</span>
            </td>
        </tr>
        <tr>
            <td>
                {!! $employment->institute_name  !!} <span style="color: rgb(139, 139, 139)">| {!! $employment->city  !!}, {!! $employment->country  !!}</span>
            </td>
        </tr>
        @endforeach
        <tr>
